...
import registerController, { registerControllerDEPRECATED } from './register-controller';
import { ICreateController } from './types';

export function buildRoutesDEPRECATED(
  router: Router,
  ...
  controllersFactory.forEach((createController) => {
    ...
    registerControllerDEPRECATED(path, controller, router);
  });
}
